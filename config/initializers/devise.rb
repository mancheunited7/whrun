...
Devise.setup do |config|
  ...
  # by default. You can change it below and use your own secret key.
   config.secret_key = '663cc490d0068f7e27fdcb80d865ce1fc5e8cadcbb0a72215723d24ce19f9ef6cd0e18f9ecace4b4db55fd41070237130025812020fb365ef9cf296a4fa90296'
  ...
  # config.pepper = 'bb552e592c4037dd3ea516ee4e74501ad4b5219a866bf25bb623f3867640fa473277d8ddda1a027b98c5419f11cf2063666452dbf59f84eeb8f4bf1768663815'
  ...
  if Rails.env.production?
    ...
    config.omniauth :google_oauth2, ENV["GOOGLE_APP_ID"], ENV["GOOGLE_APP_SECRET"],
                     ...
                     name: 'google',
                     display: 'popup', info_fields: 'email,profile'
    config.omniauth :yahoojp, ENV["YAHOOJP_KEY"], ENV["YAHOOJP_SECRET"], scope: 'openid profile email address', name: 'Yahoo',display: 'popup', info_fields: 'name,email'
  end
end
